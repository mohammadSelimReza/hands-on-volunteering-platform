# Generated by Django 5.1.7 on 2025-03-12 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('causeschoices', models.ManyToManyField(to='user.causeschoicesmodel')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to=settings.AUTH_USER_MODEL)),
                ('skills', models.ManyToManyField(to='user.skillsmodel')),
            ],
        ),
    ]
