    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp', models.CharField(blank=True, max_length=20, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('causeschoices', models.ManyToManyField(blank=True, to='user.causeschoicesmodel')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to=settings.AUTH_USER_MODEL)),
                ('skills', models.ManyToManyField(blank=True, to='user.skillsmodel')),
            ],
        ),
    ]
